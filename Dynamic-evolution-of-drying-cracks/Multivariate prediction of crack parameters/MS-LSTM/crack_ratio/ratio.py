...
#from scikeras.wrappers import SciKerasRegressor
...
dataset = read_csv('crack_ratio.csv', header=0, index_col=0)
...
def plot_training_validation_loss(train_loss, val_loss):
    ...
    loss_df.to_csv('Training_and_Validation_Loss.csv', index=False)
...
def plot_actual_vs_predicted(train_y, predicted_train_y, test_y, predicted_test_y):
    ...
    # Adjust the figure size and set DPI
    plt.figure(figsize=(15, 6), dpi=300)

    # Plot the predicted and actual results for the training set
    ...
    # Plot the predicted and actual results for the test set
